...
class SelectPaymentMethodsWidget extends StatefulWidget {
  const SelectPaymentMethodsWidget({super.key});

  @override
  State<SelectPaymentMethodsWidget> createState() =>
      _SelectPaymentMethodsWidgetState();
}

class _SelectPaymentMethodsWidgetState extends State<SelectPaymentMethodsWidget>
    with TickerProviderStateMixin {
  late SelectPaymentMethodsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SelectPaymentMethodsModel());
