...
class EmailNodalWidget extends StatefulWidget {
  const EmailNodalWidget({super.key});

  @override
  State<EmailNodalWidget> createState() => _EmailNodalWidgetState();
}

class _EmailNodalWidgetState extends State<EmailNodalWidget> {
  late EmailNodalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmailNodalModel());
