...
class LoginCoverWidget extends StatefulWidget {
  const LoginCoverWidget({super.key});

  @override
  State<LoginCoverWidget> createState() => _LoginCoverWidgetState();
}

class _LoginCoverWidgetState extends State<LoginCoverWidget> {
  late LoginCoverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginCoverModel());
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset(
                                Theme.of(context).brightness == Brightness.dark
                                    ? 'assets/images/auth-login-illustration-dark.png'
                                    : 'assets/images/auth-login-illustration-light.png',
                                fit: BoxFit.contain,
                              ),
                            ),
                          ),
