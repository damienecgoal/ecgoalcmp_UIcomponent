...
export 'invoice_edit_model.dart';

class InvoiceEditWidget extends StatefulWidget {
  const InvoiceEditWidget({super.key});

  @override
  State<InvoiceEditWidget> createState() => _InvoiceEditWidgetState();
}

class _InvoiceEditWidgetState extends State<InvoiceEditWidget> {
  late InvoiceEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvoiceEditModel());
    ...
    _model.textController1 ??= TextEditingController(
        text: 'The most developer friendly & highly customizable HTML5 Admin');
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: '24');
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(text: '1');
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.textController4 ??= TextEditingController(text: 'Edward Crowley');
